...
IMPLEMENT_META_INTERFACE(Hello, "com.ferdinand.IHello")
...
::android::binder::Status IHelloDefault::registerCallback(const ::android::sp<::com::ferdinand::ICallback>&) {
  return ::android::binder::Status::fromStatusT(::android::UNKNOWN_TRANSACTION);
}
...
::android::binder::Status BpHello::registerCallback(const ::android::sp<::com::ferdinand::ICallback>& cb) {
  ::android::Parcel _aidl_data;
  ::android::Parcel _aidl_reply;
  ::android::status_t _aidl_ret_status = ::android::OK;
  ::android::binder::Status _aidl_status;
  ...
  _aidl_ret_status = _aidl_data.writeStrongBinder(::com::ferdinand::ICallback::asBinder(cb));
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
...
::android::status_t BnHello::onTransact(uint32_t _aidl_code, const ::android::Parcel& _aidl_data, ::android::Parcel* _aidl_reply, uint32_t _aidl_flags) {
  ...
  {
    ::android::sp<::com::ferdinand::ICallback> in_cb;
    if (!(_aidl_data.checkInterface(this))) {
      _aidl_ret_status = ::android::BAD_TYPE;
      break;
    }
